	...
	public function render_all_brands( array $args = array() ): string {
		...
		return jpwbc_get_template(
			...
			array(
				...
				'sticky_index'       => ! empty( $args['sticky_index'] ),
				'sticky_offset'      => max( 0, (int) $args['sticky_offset'] ),
	...
	public function shortcode_all_brands( $atts ): string {
		...
		return $this->render_all_brands(
			array(
				...
				'sticky_index'       => $truthy( $atts['sticky_index'] ),
				'sticky_offset'      => (int) $atts['sticky_offset'],
